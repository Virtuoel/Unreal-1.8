...
public class EntityProjectileUnreal extends Entity implements IProjectile
{
    public int xTile = -1;
    public int yTile = -1;
    public int zTile = -1;
        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    {
                        damagesource = (new EntityDamageSourceIndirect("dispersionPistol", this, this)).setProjectile();
                    }
                    else
                    {
                        damagesource = (new EntityDamageSourceIndirect("dispersionPistol", this, this.shootingEntity)).setProjectile();
                    }
